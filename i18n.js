const I18N = {
  ko: {
    ...
    nav: { home: '홈', pet: 'Pet', mini: 'Mini', notes: '개발자 노트', creators: '크리에이터', collaboration: '협업 안내', aria: '주요 메뉴' },
    hero: {
      lead: '좋아하는 사람과 늘,<br>함께할 수 있도록',
      heavinyangAlt: '웃으며 손을 흔드는 헤비냥',
      ishalongAlt: '하트를 보내는 이샤롱',
    },
    characters: { hebi: '헤비냥', isha: '이샤롱', mini: 'Oshi Desk Mini' },
    hub: {
      label: 'PRODUCT HUB',
      h2: 'Oshi Desk는 두 가지 방식으로 만날 수 있어요.',
      p: '지금은 움직이는 데스크톱 펫 Pet을 바로 다운로드할 수 있습니다. Mini는 준비 중입니다.',
      petBadge: 'Animated',
      petTitle: 'Oshi Desk Pet',
      petP: '헤비냥, 이샤롱처럼 움직이는 전용 캐릭터가 바탕화면 위에서 기다리고 반응합니다.',
      petLink: 'Oshi Desk Pet 다운로드 받기',
      miniBadgeSoon: 'Coming Soon',
      miniTitle: 'Oshi Desk Mini',
      miniP: '애니메이션 없이도 원하는 이미지 두 장과 버튼 아이콘만으로 나만의 오시를 만들 수 있습니다.',
      miniSoon: '준비 중',
    },
    products: {
      label: 'Section 02',
      h2: 'Pet은 움직임으로, Mini는 자유로운 이미지로',
      p: 'Pet은 지금 바로 사용할 수 있고, 더 가볍게 직접 꾸밀 수 있는 Mini는 준비 중입니다.',
      petTitle: 'Oshi Desk Pet',
      petP: '대기, 걷기, 듣기, 잡기 등 여러 동작으로 바탕화면 위에서 살아 움직이는 느낌을 전합니다.',
      miniTitle: 'Oshi Desk Mini',
      miniP: '평상 시와 클릭 시 이미지 두 장만 준비하면 애니메이션 없이도 원하는 그림을 데스크톱에 올릴 수 있습니다.',
      miniIdle: '평상 시',
      miniClick: '클릭 시',
      miniIdleAlt: '평상 시 예시',
      miniClickAlt: '클릭 시 예시',
      miniSoon: 'Mini는 준비 중입니다.',
    },
    install: {
      label: 'QUICK START',
      h2: '시작 방법',
      s1h: '다운로드',
      s1p: '원하는 캐릭터와 운영체제를 선택합니다.',
      s2h: '설치',
      s2p: '사용 환경에 맞는 파일을 내려받습니다.',
      s3h: '실행',
      s3p: '압축을 풀고 실행 파일을 엽니다.',
      s4h: '만나기',
      s4p: '바탕화면 위에서 Pet을 만나보세요.',
    },
    download: {
      title: '나의 오시를 데스크톱으로',
      petTitle: 'Oshi Desk Pet 다운로드',
      petDesc: '원하는 캐릭터와 운영체제를 선택하세요.',
      miniTitle: 'Oshi Desk Mini 다운로드',
      miniDesc: 'Mini v0.1 배포 버전을 내려받아 바로 커스텀을 시작하세요.',
      hebi: '헤비냥 다운로드',
      isha: '이샤롱 다운로드',
      mini: 'Mini 다운로드',
      note: '최신 Windows/macOS 설치 파일 · 무료',
      heavinyangAlt: '달리는 헤비냥',
      ishalongAlt: '기뻐하는 이샤롱',
      manifestError: '다운로드 정보를 불러올 수 없습니다',
      preparing: '{name} — 준비 중',
      preparingToast: '{name} 다운로드는 준비 중입니다.',
    },
    platform: {
      win: 'Windows',
    ...
    about: {
      h2: '바탕화면 속,<br>나만의 작은 펫과 함께',
      p: '귀여운 Desk Pet이 바탕화면 위에서 기다리고, 걷고, 쉬고, 반응합니다. 작은 움직임만으로도 데스크탑에 좋아하는 사람의 분위기를 더할 수 있어요.',
      idle: '얌전히 기다려요',
      walk: '화면을 산책해요',
      listening: '함께 들어요',
      grab: '클릭해서 이동해요',
      idleAlt: '대기 중인 이샤롱',
      walkAlt: '산책하는 헤비냥',
      listeningAlt: '음악을 듣고 있는 이샤롱',
      grabAlt: '잡혀 있는 헤비냥',
    },
    channels: {
      h2: '자주 찾는 채널을<br>한 번의 클릭으로',
      p: '캐릭터나 이미지에 연결된 플로팅 UI에서 영상, 음악, SNS와 커뮤니티 등 자주 방문하는 채널로 빠르게 이동할 수 있어요.',
      panelTitle: '나의 Channel',
      demoPetAlt: '헤비냥',
    },
    project: {
      h2: '작은 연결에서 시작된 프로젝트',
      p: '좋아하는 존재가 일상 가까이에 머무는 경험을 목표로 합니다. 화면 한편의 조용한 움직임이 평범한 하루를 조금 더 다정하게 만들기를 바랍니다.',
      linkTitle: 'Oshi Desk 소식 받기',
      linkDesc: '새 캐릭터와 업데이트를 가장 먼저 확인하세요.',
      xAria: 'X에서 Oshi Desk 소식 보기',
    },
    footer: {
      tagline: '좋아하는 마음을 화면 가까이.',
      contact: '문의사항은 <a href="mailto:ssongshare0720@gmail.com">ssongshare0720@gmail.com</a>으로 보내주세요.',
    ...
    creators: {
      ...
      hero: { label: 'CREATORS', h1: '좋아하는 마음으로<br>이어진 사람들', p: '데스크톱 오시를 함께 만들고 기여한 크리에이터를 소개합니다. 캐릭터 다운로드는 Pet 페이지에서 확인할 수 있습니다.' },
    ...
    pet: {
      meta: { title: 'Oshi Desk Pet | Oshi Desk', description: '헤비냥, 이샤롱 등 움직이는 데스크톱 펫 다운로드' },
      hero: { label: 'OSHI DESK PET', h1: '움직이는 오시를<br>바탕화면 가까이에', p: '헤비냥과 이샤롱처럼 여러 동작을 가진 데스크톱 펫을 다운로드하는 페이지입니다.' },
      features: { label: 'PET FEATURES', h2: '캐릭터가 화면 위에서 자연스럽게 반응합니다.' },
    },
    mini: {
      meta: { title: 'Oshi Desk Mini | Oshi Desk', description: 'Oshi Desk Mini 다운로드와 커스텀 안내' },
      hero: { label: 'OSHI DESK MINI', h1: '원하는 그림 두 장으로<br>나만의 오시 만들기', p: '애니메이션 리소스 없이도 평상 시와 클릭 시 이미지만 있으면 바로 커스텀할 수 있는 가벼운 버전입니다.' },
      features: { label: 'MINI FEATURES', h2: '간단하지만, 원하는 만큼 나답게 꾸밀 수 있어요.', c1h: '이미지 2장으로 커스텀', c1p: '평소에 보여줄 그림과 클릭했을 때 보여줄 그림만 준비하면 내 오시를 바탕화면에 올릴 수 있습니다.', c2h: '원하는 버튼과 아이콘', c2p: '자주 찾는 링크 버튼을 만들고, 각 버튼에 어울리는 아이콘 이미지를 넣어 바로 이동할 수 있습니다.', c3h: '프로필보내기와 적용', c3p: '완성한 Mini 프로필은 파일로보내고, 다른 환경에서도 다시 적용할 수 있도록 구성합니다.', flow1: '프로필 제작', flow2: '보내기', flow3: '적용하기', fanCafe: '팬카페', miniIdleAlt: '평상 시 이미지', miniClickAlt: '클릭 시 이미지' },
    },
  },
  en: {
    meta: {
    ...
    nav: { home: 'Home', pet: 'Pet', mini: 'Mini', notes: 'Developer Notes', creators: 'Creators', collaboration: 'Collaboration', aria: 'Main menu' },
    hero: {
      lead: 'Stay close to the people<br>you love, always',
      heavinyangAlt: 'Hebinyang waving happily',
      ishalongAlt: 'Ishalong sending a heart',
    },
    characters: { hebi: 'Hebinyang', isha: 'Ishalong', mini: 'Oshi Desk Mini' },
    hub: {
      label: 'PRODUCT HUB',
      h2: 'Meet Oshi Desk in two ways.',
      p: 'Download the animated Pet now. Mini is still in preparation.',
      petBadge: 'Animated',
      petTitle: 'Oshi Desk Pet',
      petP: 'Dedicated characters like Hebinyang and Ishalong wait and react on your desktop.',
      petLink: 'Get Oshi Desk Pet',
      miniBadgeSoon: 'Coming Soon',
      miniTitle: 'Oshi Desk Mini',
      miniP: 'Build your own oshi with just two images and button icons—no animation required.',
      miniSoon: 'Coming soon',
    },
    products: {
      label: 'Section 02',
      h2: 'Pet moves with you. Mini is your canvas.',
      p: 'Pet is available now. Mini—a lighter DIY option—is coming soon.',
      petTitle: 'Oshi Desk Pet',
      petP: 'Idle, walk, listen, and grab motions bring life to the corner of your screen.',
      miniTitle: 'Oshi Desk Mini',
      miniP: 'With only idle and click images, you can place any art on your desktop without animation.',
      miniIdle: 'Idle',
      miniClick: 'On click',
      miniIdleAlt: 'Idle image example',
      miniClickAlt: 'Click image example',
      miniSoon: 'Mini is coming soon.',
    },
    install: {
      label: 'QUICK START',
      h2: 'How to get started',
      s1h: 'Download',
      s1p: 'Choose your character and operating system.',
      s2h: 'Install',
      s2p: 'Get the build for your system.',
      s3h: 'Run',
      s3p: 'Extract the archive and open the app.',
      s4h: 'Meet your Pet',
      s4p: 'Say hello on your desktop.',
    },
    download: {
      title: 'Bring your oshi to the desktop',
      petTitle: 'Download Oshi Desk Pet',
      petDesc: 'Choose your character and operating system.',
      miniTitle: 'Download Oshi Desk Mini',
      miniDesc: 'Get Mini v0.1 and start customizing right away.',
      hebi: 'Download Hebinyang',
      isha: 'Download Ishalong',
      mini: 'Download Mini',
      note: 'Latest Windows/macOS installers · Free',
      heavinyangAlt: 'Hebinyang running',
      ishalongAlt: 'Ishalong celebrating',
      manifestError: 'Could not load download info',
      preparing: '{name} — Coming soon',
      preparingToast: '{name} download is coming soon.',
    },
    platform: {
      win: 'Windows',
      mac_arm64: 'macOS (Apple Silicon)',
    ...
    about: {
      h2: 'Your own little pet<br>right on the desktop',
      p: 'A cute Desk Pet waits, walks, rests, and reacts on your screen. Even small movements can bring the warmth of someone you love to your workspace.',
      idle: 'Waiting quietly',
      walk: 'Strolling across the screen',
      listening: 'Listening along',
      grab: 'Click to move them',
      idleAlt: 'Ishalong idling',
      walkAlt: 'Hebinyang walking',
      listeningAlt: 'Ishalong listening to music',
      grabAlt: 'Hebinyang being grabbed',
    },
    channels: {
      h2: 'Your favorite channels<br>in one click',
      p: 'Use the floating UI on your character or image to jump to videos, music, social feeds, and communities you visit often.',
      panelTitle: 'My Channel',
      demoPetAlt: 'Hebinyang',
    },
    project: {
      h2: 'A project born from small connections',
      p: 'We want the people you love to stay close to everyday life. A quiet motion at the edge of your screen can make an ordinary day feel a little warmer.',
      linkTitle: 'Get Oshi Desk updates',
      linkDesc: 'Be the first to hear about new characters and updates.',
      xAria: 'Follow Oshi Desk on X',
    },
    footer: {
      tagline: 'Keep what you love close to your screen.',
      contact: 'Questions? Email us at <a href="mailto:ssongshare0720@gmail.com">ssongshare0720@gmail.com</a>.',
    ...
    creators: {
      ...
      hero: { label: 'CREATORS', h1: 'People connected<br>through love', p: 'Meet creators who build and contribute desktop oshi. Download characters from the Pet page.' },
    ...
    pet: {
      meta: { title: 'Oshi Desk Pet | Oshi Desk', description: 'Download animated desktop pets like Hebinyang and Ishalong' },
      hero: { label: 'OSHI DESK PET', h1: 'Animated oshi<br>close to your screen', p: 'Download desktop pets with multiple motions, like Hebinyang and Ishalong.' },
      features: { label: 'PET FEATURES', h2: 'Characters respond naturally on your screen.' },
    },
    mini: {
      meta: { title: 'Oshi Desk Mini | Oshi Desk', description: 'Oshi Desk Mini download and customization guide' },
      hero: { label: 'OSHI DESK MINI', h1: 'Your oshi from<br>two images', p: 'A lightweight version you can customize with idle and click images—no animation assets needed.' },
      features: { label: 'MINI FEATURES', h2: 'Simple, but personal enough to feel like yours.', c1h: 'Customize with 2 images', c1p: 'Prepare an idle image and a click image to place your oshi on the desktop.', c2h: 'Buttons and icons you want', c2p: 'Create shortcut buttons and add icon images to jump to your favorite links.', c3h: 'Export and apply profiles', c3p: 'Export finished Mini profiles as files and apply them again on other machines.', flow1: 'Build profile', flow2: 'Export', flow3: 'Apply', fanCafe: 'Fan cafe', miniIdleAlt: 'Idle image', miniClickAlt: 'Click image' },
    },
  },
  ja: {
    meta: {
    ...
    nav: { home: 'ホーム', pet: 'Pet', mini: 'Mini', notes: '開発者ノート', creators: 'クリエイター', collaboration: 'コラボ案内', aria: 'メインメニュー' },
    hero: {
      lead: '好きな人と、いつも<br>一緒にいられるように',
      heavinyangAlt: '笑顔で手を振る Hebinyang',
      ishalongAlt: 'ハートを送る Ishalong',
    },
    characters: { hebi: 'Hebinyang', isha: 'Ishalong', mini: 'Oshi Desk Mini' },
    hub: {
      label: 'PRODUCT HUB',
      h2: 'Oshi Desk は2つの形で出会えます。',
      p: '今は動く Pet をすぐダウンロードできます。Mini は準備中です。',
      petBadge: 'Animated',
      petTitle: 'Oshi Desk Pet',
      petP: 'Hebinyang や Ishalong のように、専用キャラクターがデスクトップ上で待ち、反応します。',
      petLink: 'Oshi Desk Pet をダウンロード',
      miniBadgeSoon: 'Coming Soon',
      miniTitle: 'Oshi Desk Mini',
      miniP: 'アニメーションなしでも、画像2枚とボタンアイコンだけで自分だけの推しを作れます。',
      miniSoon: '準備中',
    },
    products: {
      label: 'Section 02',
      h2: 'Pet は動きで、Mini は自由な画像で',
      p: 'Pet は今すぐ使えます。より軽く自分で飾れる Mini は準備中です。',
      petTitle: 'Oshi Desk Pet',
      petP: '待機・歩行・聴取・つかむなど、複数の動作で画面の上で生きている感じを届けます。',
      miniTitle: 'Oshi Desk Mini',
      miniP: '通常時とクリック時の画像2枚だけで、アニメーションなしでも好きな絵をデスクトップに置けます。',
      miniIdle: '通常時',
      miniClick: 'クリック時',
      miniIdleAlt: '通常時の例',
      miniClickAlt: 'クリック時の例',
      miniSoon: 'Mini は準備中です。',
    },
    install: {
      label: 'QUICK START',
      h2: '始め方',
      s1h: 'ダウンロード',
      s1p: 'キャラクターと OS を選びます。',
      s2h: 'インストール',
      s2p: '利用環境に合ったファイルを取得します。',
      s3h: '実行',
      s3p: '解凍して実行ファイルを開きます。',
      s4h: 'Pet と会う',
      s4p: 'デスクトップ上で Pet に会いましょう。',
    },
    download: {
      title: '推しをデスクトップへ',
      petTitle: 'Oshi Desk Pet ダウンロード',
      petDesc: 'キャラクターと OS を選んでください。',
      miniTitle: 'Oshi Desk Mini ダウンロード',
      miniDesc: 'Mini v0.1 を取得して、すぐカスタムを始めましょう。',
      hebi: 'Hebinyang をダウンロード',
      isha: 'Ishalong をダウンロード',
      mini: 'Mini をダウンロード',
      note: '最新の Windows/macOS インストーラー · 無料',
      heavinyangAlt: '走る Hebinyang',
      ishalongAlt: '喜ぶ Ishalong',
      manifestError: 'ダウンロード情報を読み込めませんでした',
      preparing: '{name} — 準備中',
      preparingToast: '{name} のダウンロードは準備中です。',
    },
    platform: {
      win: 'Windows',
      mac_arm64: 'macOS (Apple Silicon)',
    ...
    about: {
      h2: 'デスクトップの中で、<br>あなただけの小さなペットと',
      p: 'かわいい Desk Pet がデスクトップ上で待ち、歩き、休み、反応します。小さな動きだけでも、好きな人の雰囲気をデスクに添えられます。',
      idle: 'おとなしく待っています',
      walk: '画面をお散歩します',
      listening: '一緒に聴きます',
      grab: 'クリックして移動します',
      idleAlt: '待機中の Ishalong',
      walkAlt: '散歩する Hebinyang',
      listeningAlt: '音楽を聴く Ishalong',
      grabAlt: 'つかまれている Hebinyang',
    },
    channels: {
      h2: 'よく見るチャンネルへ<br>ワンクリックで',
      p: 'キャラクターや画像に接続されたフローティング UI から、動画・音楽・SNS・コミュニティなど、よく訪れるチャンネルへすぐ移動できます。',
      panelTitle: 'マイ Channel',
      demoPetAlt: 'Hebinyang',
    },
    project: {
      h2: '小さなつながりから始まったプロジェクト',
      p: '好きな存在が日常のすぐそばにいる体験を目指しています。画面の端の静かな動きが、いつもの一日を少しやさしくしてくれることを願っています。',
      linkTitle: 'Oshi Desk の最新情報',
      linkDesc: '新キャラクターとアップデートをいち早くチェック。',
      xAria: 'X で Oshi Desk の情報を見る',
    },
    footer: {
      tagline: '好きな気持ちを、画面のすぐそばに。',
      contact: 'お問い合わせは <a href="mailto:ssongshare0720@gmail.com">ssongshare0720@gmail.com</a> まで。',
    ...
    creators: {
      ...
      hero: { label: 'CREATORS', h1: '好きな気持ちで<br>つながった人たち', p: 'デスクトップ推しを一緒に作り、協力したクリエイターを紹介します。キャラクターのダウンロードは Pet ページからご覧ください。' },
    ...
    pet: {
      meta: { title: 'Oshi Desk Pet | Oshi Desk', description: 'Hebinyang や Ishalong など動くデスクトップペットのダウンロード' },
      hero: { label: 'OSHI DESK PET', h1: '動く推しを<br>デスクトップのそばに', p: 'Hebinyang や Ishalong のように、複数の動作を持つデスクトップペットをダウンロードするページです。' },
      features: { label: 'PET FEATURES', h2: 'キャラクターが画面上で自然に反応します。' },
    },
    mini: {
      meta: { title: 'Oshi Desk Mini | Oshi Desk', description: 'Oshi Desk Mini のダウンロードとカスタム案内' },
      hero: { label: 'OSHI DESK MINI', h1: '好きな画像2枚で<br>自分だけの推しを作る', p: 'アニメーション素材がなくても、通常時とクリック時の画像だけですぐカスタムできる軽量版です。' },
      features: { label: 'MINI FEATURES', h2: 'シンプルでも、好きなように飾れます。', c1h: '画像2枚でカスタム', c1p: '普段見せる絵とクリック時の絵だけ用意すれば、自分の推しをデスクトップに置けます。', c2h: '好きなボタンとアイコン', c2p: 'よく開くリンクボタンを作り、各ボタンに合うアイコン画像を入れてすぐ移動できます。', c3h: 'プロフィールの書き出しと適用', c3p: '完成した Mini プロフィールはファイルに書き出し、別の環境でも再適用できます。', flow1: 'プロフィール制作', flow2: '書き出し', flow3: '適用', fanCafe: 'ファンカフェ', miniIdleAlt: '通常時の画像', miniClickAlt: 'クリック時の画像' },
    },
  },
  'zh-TW': {
    meta: {
    ...
    nav: { home: '首頁', pet: 'Pet', mini: 'Mini', notes: '開發者筆記', creators: '創作者', collaboration: '合作指南', aria: '主要選單' },
    hero: {
      lead: '讓喜歡的人，<br>始終陪在身邊',
      heavinyangAlt: '笑著揮手的 Hebinyang',
      ishalongAlt: '送出愛心的 Ishalong',
    },
    characters: { hebi: 'Hebinyang', isha: 'Ishalong', mini: 'Oshi Desk Mini' },
    hub: {
      label: 'PRODUCT HUB',
      h2: 'Oshi Desk 有兩種方式與你見面。',
      p: '現在可直接下載會動的 Pet。Mini 仍在準備中。',
      petBadge: 'Animated',
      petTitle: 'Oshi Desk Pet',
      petP: '像 Hebinyang、Ishalong 這樣的專屬角色會在桌面上等待並回應你。',
      petLink: '取得 Oshi Desk Pet',
      miniBadgeSoon: 'Coming Soon',
      miniTitle: 'Oshi Desk Mini',
      miniP: '不需動畫，只要兩張圖片與按鈕圖示就能打造專屬推。',
      miniSoon: '準備中',
    },
    products: {
      label: 'Section 02',
      h2: 'Pet 用動態，Mini 用自由圖像',
      p: 'Pet 現在就能使用，更輕量的 Mini 仍在準備中。',
      petTitle: 'Oshi Desk Pet',
      petP: '待機、行走、聆聽、抓取等動作，讓角色在桌面上活起來。',
      miniTitle: 'Oshi Desk Mini',
      miniP: '只要準備平常與點擊時的兩張圖，不需動畫也能把喜歡的圖放上桌面。',
      miniIdle: '平常',
      miniClick: '點擊時',
      miniIdleAlt: '平常狀態範例',
      miniClickAlt: '點擊狀態範例',
    ...
    download: {
      title: '把推帶到桌面上',
      petTitle: '下載 Oshi Desk Pet',
      petDesc: '選擇角色與作業系統。',
      miniTitle: '下載 Oshi Desk Mini',
      miniDesc: '取得 Mini v0.1，立即開始自訂。',
      hebi: '下載 Hebinyang',
      isha: '下載 Ishalong',
      mini: '下載 Mini',
      note: '最新 Windows/macOS 安裝檔 · 免費',
      heavinyangAlt: '奔跑的 Hebinyang',
      ishalongAlt: '開心的 Ishalong',
      manifestError: '無法載入下載資訊',
      preparing: '{name} — 準備中',
      preparingToast: '{name} 下載尚在建置中。',
    },
    platform: {
      win: 'Windows',
      mac_arm64: 'macOS (Apple Silicon)',
    ...
    about: {
      h2: '在桌面上，<br>與專屬小寵物同行',
      p: '可愛的 Desk Pet 會在桌面上等待、行走、休息並回應你。即使只是小小的動作，也能為桌面添上喜愛之人的氛圍。',
      idle: '安靜地等待著',
      walk: '在螢幕上散步',
      listening: '一起聆聽',
      grab: '點擊來移動',
      idleAlt: '待機中的 Ishalong',
      walkAlt: '散步中的 Hebinyang',
      listeningAlt: '聽音樂的 Ishalong',
      grabAlt: '被抓住的 Hebinyang',
    },
    channels: {
      h2: '常看的頻道，<br>一鍵直達',
      p: '透過角色或圖像上的浮動介面，快速前往影片、音樂、社群與論壇等你常造訪的頻道。',
      panelTitle: '我的 Channel',
      demoPetAlt: 'Hebinyang',
    },
    project: {
      h2: '從微小連結開始的專案',
      p: '我們希望喜愛的存在能留在日常身旁。螢幕一角輕柔的動態，能讓平凡的一天多一點溫暖。',
      linkTitle: '接收 Oshi Desk 最新消息',
      linkDesc: '搶先了解新角色與更新內容。',
      xAria: '在 X 上查看 Oshi Desk 動態',
    },
    footer: {
      tagline: '把喜愛的心意，留在螢幕身旁。',
    ...
    creators: {
      ...
      hero: { label: 'CREATORS', h1: '因喜愛而<br>連結的人們', p: '介紹一同製作、貢獻桌面推的創作者。角色下載請至 Pet 頁面查看。' },
    ...
    pet: {
      meta: { title: 'Oshi Desk Pet | Oshi Desk', description: '下載 Hebinyang、Ishalong 等會動的桌面寵物' },
      hero: { label: 'OSHI DESK PET', h1: '會動的推<br>就在桌面身旁', p: '這裡可下載像 Hebinyang、Ishalong 這樣具多種動作的桌面寵物。' },
      features: { label: 'PET FEATURES', h2: '角色會在螢幕上自然回應。' },
    },
    mini: {
      meta: { title: 'Oshi Desk Mini | Oshi Desk', description: 'Oshi Desk Mini 下載與自訂說明' },
      hero: { label: 'OSHI DESK MINI', h1: '用兩張圖片<br>打造專屬推', p: '不需動畫素材，只要平常與點擊時的圖片就能立刻自訂的輕量版本。' },
      features: { label: 'MINI FEATURES', h2: '簡單，卻能依喜好充分裝飾。', c1h: '用 2 張圖片自訂', c1p: '只要準備平常顯示與點擊時的圖片，就能把推放到桌面上。', c2h: '想要的按鈕與圖示', c2p: '建立常用連結按鈕，並為每個按鈕放入合適的圖示即可快速前往。', c3h: '設定檔匯出與套用', c3p: '完成的 Mini 設定檔可匯出為檔案，並在其他環境再次套用。', flow1: '製作設定檔', flow2: '匯出', flow3: '套用', fanCafe: '粉絲社團', miniIdleAlt: '平常狀態圖片', miniClickAlt: '點擊狀態圖片' },
    },
  },
};
...
function translate(lang, key, vars) {
  const value = getNested(I18N[lang], key) ?? getNested(I18N.ko, key) ?? key;
  if (!vars) return value;
  return String(value).replace(/\{(\w+)\}/g, (_, name) => (vars[name] != null ? vars[name] : `{${name}}`));
}
...
function applyLanguage(lang) {
  ...
  document.querySelectorAll('[data-i18n]').forEach((el) => {
    ...
    const text = translate(currentLang, key);
  ...
  const langBadge = document.querySelector('.lang-current');
  if (langBadge) {
    const badges = { ko: 'KO', en: 'EN', ja: 'JA', 'zh-TW': 'ZH' };
    langBadge.textContent = badges[currentLang] || 'KO';
  }

  const langToggle = document.getElementById('langToggle');
  if (langToggle) {
    langToggle.setAttribute('aria-label', dict.lang.label);
    langToggle.setAttribute('title', dict.lang.label);
  }
...
window.OshiI18n = { t: translate, getLang, applyLanguage, I18N };
